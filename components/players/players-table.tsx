        ...
        <TableBody>
          {isLoading ? (
            ...
            >
              ...
              <TableCell>{player.stats.tFreePlay.toLocaleString()}</TableCell>
              <TableCell>${player.stats.tDeposit.toLocaleString()}</TableCell>
              <TableCell>${player.stats.tWithdraw.toLocaleString()}</TableCell>
              <TableCell>{player.stats.tBonusPlay.toLocaleString()}</TableCell>
              <TableCell>{player.stats.tReferralBonus.toLocaleString()}</TableCell>
              <TableCell>${player.stats.pAndL.toLocaleString()}</TableCell>
              <TableCell className="text-right">
                <DropdownMenu>
                  ...
                  <DropdownMenuContent align="end">
                    ...
                    <DropdownMenuItem onSelect={() => onDelete(player)}>
